...
var escapeStringRegexp = __webpack_require__(89);
var ansiStyles = __webpack_require__(82);
var stripAnsi = __webpack_require__(192);
var hasAnsi = __webpack_require__(92);
...
const xml2js = __webpack_require__(196);
...
function filterArgumentsForCordova(metadata, inputs, options) {
    let results = cli_utils_1.normalizeOptionAliases(metadata, options);
    results = filterByIntent(metadata, results, exports.CORDOVA_INTENT);
 ...
 */
function generateAppScriptsArguments(metadata, inputs, options) {
    let results = cli_utils_1.normalizeOptionAliases(metadata, options);
    results = filterByIntent(metadata, results);
    let args = cli_utils_1.minimistOptionsToArray(results);
...
exports.generateAppScriptsArguments = generateAppScriptsArguments;
...
(function() {
  ...
  isEmpty = __webpack_require__(183);
  ...
  module.exports = XMLNode = (function() {
    function XMLNode(parent) {
      ...
      if (XMLElement === null) {
        ...
        XMLComment = __webpack_require__(66);
        XMLDeclaration = __webpack_require__(67);
        XMLDocType = __webpack_require__(68);
        XMLRaw = __webpack_require__(203);
        XMLText = __webpack_require__(205);
      }
    }
...
module.exports = require("@ionic/app-scripts");
...
const node_fetch_1 = __webpack_require__(210);
const cli_utils_1 = __webpack_require__(0);
const configXmlUtils_1 = __webpack_require__(5);
...
function getSourceImages(buildPlatforms, resourceTypes, resourceDir) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return sourceImages.map((img, index) => (__assign({}, img, { imageId: sourceImageChecksums[index] })));
    });
}
...
function getAvailableIPAddress() {
    ...
    return flatten(Object.keys(interfaces).map(deviceName => (interfaces[deviceName].map(item => ({
...
(function() {
  ...
  XMLDTDEntity = __webpack_require__(201);

  XMLDTDElement = __webpack_require__(200);
...
const cli_utils_1 = __webpack_require__(0);
const build_1 = __webpack_require__(73);
const compile_1 = __webpack_require__(74);
const emulate_1 = __webpack_require__(75);
const platform_1 = __webpack_require__(76);
const plugin_1 = __webpack_require__(77);
const prepare_1 = __webpack_require__(78);
const resources_1 = __webpack_require__(79);
const run_1 = __webpack_require__(80);
...
const configXmlUtils_1 = __webpack_require__(5);
const setup_1 = __webpack_require__(16);
/**
...
let BuildCommand = class BuildCommand extends cli_utils_1.Command {
    run(inputs, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const appScriptsArgs = cordova_1.generateAppScriptsArguments(this.metadata, inputs, options);
            tasks.end();
            ...
            const appScripts = __webpack_require__(37);
            const context = appScripts.generateContext();
            yield appScripts.build(context);
...
const configXmlUtils_1 = __webpack_require__(5);
const cordova_1 = __webpack_require__(7);
const network_1 = __webpack_require__(41);
const setup_1 = __webpack_require__(16);
/**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!isLiveReload) {
                ...
                if (availableIPs.length > 1) {
                    const promptAnswers = yield this.env.inquirer.prompt({
                        type: 'list',
                        name: 'ip',
                ...
                // We are using require because app-scripts reads process.argv during parse
                const serverSettings = yield appScripts.serve(context);
                yield configXmlUtils_1.writeConfigXmlContentSrc(this.env.project.directory, `http://${chosenIP}:${serverSettings.httpPort}`);
...
const cordova_1 = __webpack_require__(7);
const configXmlUtils_1 = __webpack_require__(5);
const resources_1 = __webpack_require__(40);
/**
    ...
    run(inputs, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let imgResources = resources_1.flattenResourceJsonStructure(resourceJsonStructure)
                ...
                .filter((img) => resourceTypes.includes(img.resType))
                .map((img) => (__assign({}, img, { dest: path.join(resourceDir, img.platform, img.resType, img.name) })));
            ...
            imgResources = imgResources.map((imageResource) => {
                ...
                return __assign({}, imageResource, { imageId: mostSpecificImageAvailable ? mostSpecificImageAvailable.imageId : null });
            });
            /**
            ...
            srcImagesAvailable = srcImagesAvailable.map((img, index) => {
                return __assign({}, img, { width: imageUploadResponses[index].Width, height: imageUploadResponses[index].Height, vector: imageUploadResponses[index].Vector });
            });
            /**
...
module.exports =
{
  parallel      : __webpack_require__(85),
  serial        : __webpack_require__(86),
...
var DelayedStream = __webpack_require__(88);
...
var http = __webpack_require__(208);
var https = __webpack_require__(209);
var parseUrl = __webpack_require__(213).parse;
var fs = __webpack_require__(71);
var mime = __webpack_require__(190);
var asynckit = __webpack_require__(83);
var populate = __webpack_require__(91);
...
var arrayEvery = __webpack_require__(101),
    baseEvery = __webpack_require__(110),
...
var db = __webpack_require__(189)
...
;(function (sax) { // wrapper for non-node envs
  ...
  SAXStream.prototype.write = function (data) {
    if (typeof Buffer === 'function' &&
      ...
      if (!this._decoder) {
        var SD = __webpack_require__(211).StringDecoder
...
(function() {
  ...
  sax = __webpack_require__(191);

  events = __webpack_require__(207);
  ...
  setImmediate = __webpack_require__(212).setImmediate;
...
(function() {
  ...
  XMLStringifier = __webpack_require__(204);
...
(function() {
  ...
  XMLBuilder = __webpack_require__(198);
...
function run(envInstance) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let projectData = yield envInstance.project.load();
        if (!projectData.v2) {
            throw new cli_utils_1.FatalException(`Ionic CLI v3 only supports Ionic2 projects. If you are currently working on v1 projects\n` +
                `then you should continue to use Ionic CLI v2 for now. ${chalk.bold('npm install -g ionic@2')}\n`);
        }
        yield cli_utils_1.runCommand(__assign({ namespace: cordovaNamespace }, envInstance));
    });
}
exports.run = run;
